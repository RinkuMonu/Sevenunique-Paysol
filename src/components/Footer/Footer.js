    ...
    <footer className="footer">
      ...
      <div className="primary-footer">
        <div className="container">
          <div className="row">
            {/* Company Overview */}
            <div className="col-lg-3 col-md-5 mt-6 mt-md-0">
              <h5>Sevenunique</h5>
              <div className="w-75">
            ...
            {/* Links Section */}
            <div className="col-lg-5 col-md-8 mt-6 mt-lg-0">
              <div className="row">
                ...
                <div className="col-md-7 mt-5 mt-md-0 footer-menu ms-4">
                  <h5>Services</h5>
                  <div className="d-flex flex-wrap">
                    <ul className="col-md-6 list-unstyled">
                      <li><Link to="/recharge">Recharge & Bill Pay</Link></li>
                      <li><Link to="/transfer-to-bank">Transfer to Bank</Link></li>
                      <li><Link to="/redeem-payback-points">Redeem Payback Points</Link></li>
                      <li><Link to="/wallet-transfer">Wallet Transfer</Link></li>
            ...
            <div className="col-lg-4 col-md-5 mt-6 mt-md-0">
              ...
              <ul className="media-icon list-unstyled">
                ...
                <li className="d-flex">
                  <img src="/assets/Home/send-mail.png" width={33} alt="email" />
                  <a href="mailto:info@7unique.in" className="ms-2 text-white">info@7unique.in</a>
                </li>
                <li className="d-flex">
                  <img src="/assets/Home/phone-call.png" width={33} alt="phone" />
                  <a href="tel:01414511098" className="ms-2 text-white">0141-4511098</a>
                </li>
              </ul>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-12 text-center">
              <p
                ...
                style={{ zIndex: "99" }}
              >
                © {new Date().getFullYear()} <strong>Sevenunique Tech Solutions Private Limited.</strong> All rights reserved.
              </p>
            </div>
          </div>
        </div>
