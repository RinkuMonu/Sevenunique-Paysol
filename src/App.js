...
import PaymentCheck from "./pages/My_Wallet/PaymentCheck";
import PaymentMode from "./pages/services/PaymentMode/PaymentMode";
import TransferToBank from "./pages/services/TransferToBank/TransferToBank";
import RedeemPayback from "./pages/services/Redeem/RedeemPayback";
import WalletTransfer from "./pages/services/WalletTransfer/WalletTransfer";
import Page404 from "./pages/Page404";
import KYC from "./pages/Kyc/KYC";
import AadharCard from "./pages/Kyc/AadharCard";
import PaymentSuccessPage from "./pages/PaymentSuccessPage/PaymentSuccessPage";
import PaymentErrorPage from "./pages/PaymentErrorPage/PaymentErrorPage";
import ContentPolicy from "./pages/ContentPolicy";
import UserAccountCreation from "./pages/Registrationform/Userform";
import Retailerform from "./pages/Registrationform/Retailerform";
import BillPaymentSystem from "./pages/services/BillPaymentSystem";
import { UserProvider } from "./context/UserContext";
import CreateAccount from "./pages/Login/CreateAccount";
// import CreateAccount from "./pages/Registrationform/Retailerform";

// ✅ User context import kiya (global login check ke liye)
// import { UserProvider } from "./components/services/UserContext";

function App() {
  // React Router ka browser router
  const router = createBrowserRouter([
    {
      path: "/", // Root path
      element: (
        <>
          {/* AppLayout: header, footer, outlet sabko wrap karta hai */}
          <AppLayout />
          {/* ScrollToTop: har route change pe page upar scroll ho jaata hai */}
          <ScrollToTop />
        </>
      ),
      // Nested child routes
      children: [
        ...
        { path: "/failure", element: <PaymentErrorPage /> },
        { path: "/contentpolicy", element: <ContentPolicy /> },
        { path: "/register/useraccountcreation", element: <UserAccountCreation /> },
        { path: "/registerform", element: <Retailerform /> },
        { path: "/billpayment", element: <BillPaymentSystem /> },
  ...
  return (
    // ✅ UserProvider se pura app wrap kiya gaya, taaki har component me user info & login status mile
    <UserProvider>
      {/* RouterProvider me router pass kiya */}
