                    ...
                    <form className="row g-3 needs-validation" noValidate onSubmit={handleSubmitSignUp}>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          required
                        />
                        {!isValid && <div className="invalid-feedback">{String(errorMessage)}</div>}
                      </div>
                        ...
                        <form className="row g-3 needs-validation" noValidate onSubmit={handleSubmitOTP}>
                          <div className="mb-3">
                            ...
                            <input
                              ...
                              required
                            />
                            {errorMessage && <div className="invalid-feedback">{String(errorMessage)}</div>}
                          </div>
                    ...
                    {flipState === "login" && (
                      <>
                        ...
                        <form className="row g-3 needs-validation">
                          ...
                          <button className="btn btn-primary OtpBtn" type="button">
                            Submit
                          </button>
                          <hr style={{ margin: "100px 0 10px" }} />
                          <div className="already-account mt-auto">
                            <h3>New to SEVENUNIQUE TECH SOLUTION PRIVATE LIMITED?</h3>
                            <button
