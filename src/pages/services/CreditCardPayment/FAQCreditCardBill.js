  ...
  const content = [
      ...
      body: (
        <>
          <p>
            ...
            make online credit card payments using SEVENUNIQUE TECH SOLUTIONS PRIVATE LIMITED. 
          </p>
          <p>
            SEVENUNIQUE TECH SOLUTIONS PRIVATE LIMITED. provides a convenient and seamless experience for users to
    ...
    },
    {
      ...
      body: (
        <>
          <p>
            SEVENUNIQUE TECH SOLUTIONS PRIVATE LIMITED. supports credit card payments for a wide range of banks,
            including:
          </p>
          <ul>
            <li>HDFC Bank</li>
      ...
      body: (
        <ul>
          ...
          <li>
            ...
            <br />
            Payments made via SEVENUNIQUE TECH SOLUTIONS PRIVATE LIMITED. usually take 2-3 business days to
            process.
          </li>
        </ul>
      ),
