  ...
  const content = [
    {
      ...
      body: (
        <>
          <p>
            SEVENUNIQUE TECH SOLUTION PRIVATE LIMITED. introduces new service to their consumers to
            pay their landline bills online. Now there is no need to stand in
            the long queue to pay their landline bills for hours. Sevenunique
            ...
            cards, credit cards, net banking. SEVENUNIQUE TECH SOLUTION PRIVATE LIMITED. offers
