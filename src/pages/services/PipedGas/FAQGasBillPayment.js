...
const FAQGasBillPayment = () => {
  ...
  const content = [
      ...
      body: (
        <>
          <p>
            ...
            website . No need to spend hours in long queues, SEVENUNIQUE TECH SOLUTIONS PVT LTD is one of
    ...
    {
      title: "How to Make Gas Bill Payment Online at SEVENUNIQUE TECH SOLUTIONS PVT LTD?",
      body: (
        <>
          <p>
            ...
            out. A user can make the online gas payment using the SEVENUNIQUE TECH SOLUTIONS PVT LTD app
            or by visiting the website. SEVENUNIQUE TECH SOLUTIONS PVT LTD completes the gas bill payment
          ...
          <ol>
            <li>
              ...
              Gas’ on the SEVENUNIQUE TECH SOLUTIONS PVT LTD app.
            </li>
      ...
      body: (
        <>
          <p>
            ...
            instant online payment platforms like SEVENUNIQUE TECH SOLUTIONS PVT LTD, online gas payment
          ...
          <ul>
            <li>
              ...
              like SEVENUNIQUE TECH SOLUTIONS PVT LTD, user’s money, data, and transactions are highly
              protected.
            </li>
            <li>
    ...
    {
      title: "Why Use SEVENUNIQUE TECH SOLUTIONS PVT LTD for Gas Bill Payment?",
      body: (
        <>
          <p>
            SEVENUNIQUE TECH SOLUTIONS PVT LTD, one of India’s largest digital payment apps, offers you
            ...
            was never this easy before; using the SEVENUNIQUE TECH SOLUTIONS PVT LTD app it is a few-step
            process. Here are the few listed benefits of using the SEVENUNIQUE TECH SOLUTIONS PVT LTD app
            to pay gas bills:
          </p>
          <ul>
            <li>
              <strong>Instant Payments:</strong> Pay gas bills quickly in almost
              less than a minute using the SEVENUNIQUE TECH SOLUTIONS PVT LTD app. It’s easy and with
              multiple payment modes becomes convenient for a user.
            </li>
            <li>
              <strong>More discounts:</strong> Using the SEVENUNIQUE TECH SOLUTIONS PVT LTD app, a user
            ...
            <li>
              ...
              using SEVENUNIQUE TECH SOLUTIONS PVT LTD, safety is guaranteed to the user. The user data
      ...
      body: (
        <ul>
          <li>
            ...
            <br />
            To pay the gas bill, a user can simply visit the SEVENUNIQUE TECH SOLUTIONS PVT LTD website or
          ...
          <li>
            ...
            The gas bill payment through the SEVENUNIQUE TECH SOLUTIONS PVT LTD app will be successful.
          </li>
          <li>
