  ...
  const content = [
    ...
    },
    {
      ...
      body: (
        <>
          <p>
            Online data card recharge via Sevenunique Small Pvt. Ltd. is a simple and a quick
          ...
          <ol>
            <li>
              ...
              the Sevenunique Small Pvt. Ltd. app/ website
            </li>
            <li>
    ...
    {
      title: "Why Choose Sevenunique Small Pvt. Ltd. for Data Card Recharge",
      body: (
        <>
          <p>
            Sevenunique Small Pvt. Ltd. ensures ease and convenience to all its users. It is the
            ...
            recharge, Sevenunique Small Pvt. Ltd. also ensures exciting online data card recharge
            offers including huge Cashback and SuperCash offers. Following are
            the key benefits of making online data card recharge using Sevenunique Small Pvt. Ltd..
          </p>
          <ul>
            <li>
              <strong>Instant Payment:</strong> On Sevenunique Small Pvt. Ltd. all internet service
              ...
              just a click away. Sevenunique Small Pvt. Ltd. ensures a seamless process of making
              the online data card recharge
            </li>
            <li>
              <strong>Data card recharge offers:</strong> With the Sevenunique Small Pvt. Ltd. app,
            ...
            <li>
              ...
              using the Sevenunique Small Pvt. Ltd. app or website is highly secured. The app
              assures the utmost safety and confidentiality as you pay for your
              online data card recharge
            </li>
            <li>
              <strong>Data Card Recharge Offers:</strong> On Sevenunique Small Pvt. Ltd., a user
      ...
      body: (
        <ul>
          <li>
            ...
            <br />A user can easily avail dongle recharge plans on Sevenunique Small Pvt. Ltd.
